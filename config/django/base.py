...
LOCAL_APPS = [
    'insighthub.core.apps.CoreConfig',
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://ihub:ihub@127.0.0.1:5432/insighthub'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'insighthub.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'insighthub.api.exception_handlers.hacksoft_proposed_exception_handler',
